...
namespace scala {
    ...
    void __install__(PyObject *module)
    {
        t_Function1::install(module);
        t_Function1$mcID$sp::install(module);
        t_ScalaObject::install(module);
    ...
    void __initialize__(PyObject *module)
    {
        t_Function1::initialize(module);
        t_Function1$mcID$sp::initialize(module);
        t_ScalaObject::initialize(module);
